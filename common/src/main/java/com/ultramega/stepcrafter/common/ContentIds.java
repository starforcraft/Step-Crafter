...
public final class ContentIds {
    ...
    public static final ResourceLocation STEP_CRAFTING_MONITOR = createStepCrafterIdentifier("step_crafting_monitor");
    ...
    public static final ResourceLocation STEP_CRAFTING_PREVIEW = createStepCrafterIdentifier("step_crafting_preview");
