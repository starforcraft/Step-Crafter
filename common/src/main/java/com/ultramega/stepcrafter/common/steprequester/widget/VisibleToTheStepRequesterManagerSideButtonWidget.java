...
public class VisibleToTheStepRequesterManagerSideButtonWidget extends AbstractYesNoSideButtonWidget {
    private static final MutableComponent TITLE =
        createStepCrafterTranslation("gui", "step_requester.visible_to_the_step_requester_manager");
    private static final MutableComponent HELP =
        createStepCrafterTranslation("gui", "step_requester.visible_to_the_step_requester_manager.help");
    ...
    public VisibleToTheStepRequesterManagerSideButtonWidget(final ClientProperty<Boolean> property) {
